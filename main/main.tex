...
\begin{frame}{Lowest precision exploration}
    ...
    \vspace{5mm}
\input{piecewise_figure.tex}
\end{frame}

%\begin{frame}{Exploration step-by-step}
%\begin{figure}
%    \centering
%    \input{main/newton-gif.tex}
...
\begin{figure}
    \centering
    \begin{tabular}{cl}
    \multicolumn{2}{c}{\includegraphics[width=\linewidth]{images/legend-4.pdf}} \\
    Entire application & Deflated part \\
    \includegraphics[width=.49\linewidth]{images/upper-left.pdf} & \includegraphics[width=.49\linewidth]{images/upper-right.pdf} \\
    \includegraphics[width=.49\linewidth]{images/bottom-left.pdf} & \includegraphics[width=.49\linewidth]{images/bottom-right.pdf} \\
    \end{tabular}
    \vspace{-6mm}
